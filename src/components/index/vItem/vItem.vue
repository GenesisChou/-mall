...
<template>
    <div class='v-item' @click='router'>
        <header class='head'>
            ...
            <img v-if='item.script' class='red-arrows' src="./redArrows.png">
    ...
    export default {
        ...
        computed: {
            icon() {
                const label_list = [{
                    name: '兑换',
                    img: require('./exchange.png')
                }, {
                    name: '刮卡',
                    img: require('./scrap.png')
                }, {
                    name: '问答',
                    img: require('./quiz.png')
                }, {
                    name: '摇一摇',
                    img: require('./shake.png')
                }, {
                    name: '游戏',
                    img: require('./game.png')
                }, {
                    name: '转盘',
                    img: require('./fortune.png')
                }];
                ...
                return result || require('./exchange.png');
            },
            router_link() {
                if (this.item.type == 1) {
                    return {
