...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__vAwordBox__ = __webpack_require__(81);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__vAwordBox___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__vAwordBox__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    components: {
        ...
        vAwordBox: __WEBPACK_IMPORTED_MODULE_1__vAwordBox___default.a
    },
    props: {
    ...
    watch: {
        state: function state(value) {
            ...
            if (value == 'start') {
                ...
                AIR.Game.gameOver(function (score) {
                    _this2.state = 'stop';
                });
            } else if (value == 'stop') {
                AIR.Game.stopGame();
        ...
        game_id: function game_id(value) {
            var _this3 = this;

            this.getGameDetail(value).then(function (data) {
                /*
                 * 各个游戏的游戏代码为：
                 * 接元宝游戏：   8Ew3kl53
                 * 逝去的青春：   o3KdlWed
                ...
                game_list.forEach(function (item) {
                    if (item.name == _this3.name) {
                        _this3.game = item.code;
                        return;
                    }
                });
            });
        },
        game: function game(value) {
            var _this4 = this;

            if (!value) return;
            var url = 'http://m.goldmiao.com/yngame/' + value + '.min.1.0.0.js';
            this.$script(url, function () {
                console.log('game loaded');
                _this4.game_loaded = true;
            });
        },
            ...
            if (value) {
                this.alert = {
                    ...
                    callback_close: function callback_close() {
                        _this5.init();
                        _this5.$refs.container.replaceChild(new_canvas, old_canvas);
                    },
                    btn_text: '查看'
                };
            } else {
    ...
    created: function created() {
        this.$script = __webpack_require__(16);
    },
    ...
    methods: {
        ...
        getGameDetail: function getGameDetail(game_id) {
            var _this6 = this;

            return new Promise(function (resolve) {
                _this6.$http.post(APP.HOST + '/game_detail/' + game_id, {
                    token: APP.TOKEN,
                    user_id: APP.USER_ID
        ...
        startGame: function startGame() {
            ...
            this.$http.post(APP.HOST + '/game_activity/' + this.id, {
                ...
                _this7.$store.dispatch('toggleLoading');
                var data = response.data;
                if (data.status == APP.SUCCESS) {
                    _this7.state = 'start';
                    _this7.activity_result = data.data;
                    _this7.is_win = _this7.activity_result.is_win;
                } else {
                    _this7.toggleDialog({
                        msg: data.info
                    });
...
// module
exports.push([module.i, ".game-detail[data-v-21657681]{min-height:16.66667rem;padding-bottom:1.12rem;background-color:#fff}.game[data-v-21657681]{position:relative;width:100%;height:5.33333rem}.banner[data-v-21657681]{position:absolute;left:0;top:0;width:100%;height:100%}.start[data-v-21657681]{position:absolute;left:50%;top:50%;width:3.57333rem;height:1.41333rem;padding:0;font-size:.4rem;background:url(" + __webpack_require__(290) + ");background-size:3.78667rem 1.68rem;background-repeat:no-repeat;background-position-x:inherit;z-index:2;-webkit-transform:translate(-50%,-50%);-ms-transform:translate(-50%,-50%);transform:translate(-50%,-50%)}.cover[data-v-21657681]{position:absolute;left:0;top:0;right:0;bottom:0;background-color:rgba(0,0,0,.5);z-index:1}.free-time-message[data-v-21657681]{position:absolute;color:#fff;left:50%;top:65%;-webkit-transform:translateX(-50%);-ms-transform:translateX(-50%);transform:translateX(-50%);z-index:2}.describe[data-v-21657681]{padding:.66667rem .53333rem 0}.describe .editor-style[data-v-21657681]{padding-top:.26667rem;padding-bottom:.53333rem}.describe.red .editor-style[data-v-21657681]{color:#ad0406}.describe.green .editor-style[data-v-21657681]{color:#6a3c05}", ""]);
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../../../../node_modules/css-loader/index.js?minimize&-autoprefixer!../../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-21657681&scoped=true!../../../../../node_modules/sass-loader/index.js!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./game.vue", function() {
			var newContent = require("!!../../../../../node_modules/css-loader/index.js?minimize&-autoprefixer!../../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-21657681&scoped=true!../../../../../node_modules/sass-loader/index.js!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./game.vue");
...
module.exports = __webpack_require__.p + "images/start.d9b442f103ca1f20780af65fa9481e05.png";
...
Component.options.__file = "/Users/genesischou/Documents/integral-mall/src/views/activityDetail/components/game/game.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-21657681", Component.options)
  } else {
    hotAPI.reload("data-v-21657681", Component.options)
  }
})()}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return (_vm.game) ? _c('div', {
    staticClass: "game-detail"
  }, [_c('main', {
    ref: "container",
    staticClass: "game"
  }, [(_vm.state == "ready") ? [_c('img', {
    staticClass: "banner",
    attrs: {
    ...
    staticClass: "free-time-message"
  }, [_vm._v(_vm._s(_vm.notice))])] : _vm._e(), _vm._v(" "), _c('canvas', {
    attrs: {
      "id": "canvas"
    }
  })], 2), _vm._v(" "), (_vm.state == "ready") ? _c('article', {
    class: ["describe", _vm.color]
  }, [_c('v-describe-title', {
    attrs: {
      "text": "详细说明",
      "color": _vm.color
  ...
  })], 1) : _vm._e(), _vm._v(" "), (_vm.state == "ready") ? _c('footer', [_c('v-aword-box', {
    attrs: {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-21657681", module.exports)
  }
}
