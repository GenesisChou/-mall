...
/* harmony default export */ __webpack_exports__["default"] = ({
        ...
        state: function state(value) {
            ...
            if (value === 'stop') {
                ...
                if (this.is_win) {
                    ...
                    //获取三个不重复的数字组成的数组
                    var random_array = this.createRandomArray();
                    this.rotate(0, random_array[0]);
                    this.rotate(1, random_array[1], 1000);
                    this.rotate(2, random_array[2], 2000, function () {
                        setTimeout(function () {
                            _this.toggleDialog(_this.alert);
                        }, 500);
                    });
    ...
    methods: {
        ...
        rotate: function rotate(group_num, stop_num) {
            var _this4 = this;

            var delay_time = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0;
            var callback = arguments[3];

            this.loop(group_num, stop_num, delay_time, function () {
                _this4.stop(group_num, stop_num).then(function () {
                    if (callback) {
                        callback();
                    }
                });
        ...
        loop: function loop(group_num, stop_num, delay_time, callback) {
            var _this5 = this;
            ...
            setTimeout(function () {
                var timer = setInterval(function () {
                    _this5.groups[group_num].style.marginTop = '-' + current_top + '%';
                    current_top += 10;
                    if (current_top > limit_top + 100) {
                        current_top = 0;
                        if (++current_turn > turns) {
                            clearInterval(timer);
                            _this5.groups[group_num].style.marginTop = 0;
                            if (callback) {
                                callback();
                            }
                        }
        ...
        stop: function stop(group_num, stop_num) {
            var _this6 = this;

            return new Promise(function (resolve) {
                var current_top = 0;
                var timer = setInterval(function () {
                    _this6.groups[group_num].style.marginTop = '-' + current_top + '%';
                    current_top += 10;
                    if (stop_num === 0) {
                        stop_num = _this6.activityDetail.items.length;
                    }
        ...
        getPosition: function getPosition(name, awords) {
            var stop_num = 0;
            awords.forEach(function (award, index) {
                if (award.name === name) {
                    stop_num = index;
                    return true;
                }
        ...
        createRandomArray: function createRandomArray() {
            var temp = {},
                result = [],
...
// module
exports.push([module.i, ".v-machine[data-v-43e37cde]{position:relative;min-height:16.66667rem;padding-bottom:1.12rem;background-color:#64acff}.v-machine li[data-v-43e37cde],.v-machine ul[data-v-43e37cde]{list-style:none}.header[data-v-43e37cde]{position:relative;width:10rem;height:5.33333rem;margin-bottom:-.16rem}.banner-decoration[data-v-43e37cde]{position:absolute;left:0;top:0;width:10rem;height:.49333rem}.banner[data-v-43e37cde]{width:10rem;height:5.78667rem}.background[data-v-43e37cde]{position:absolute;width:10rem;height:13.68rem;left:0;top:1.2rem}.machine[data-v-43e37cde]{position:relative;padding:.42667rem;margin:.88rem auto;width:9.86667rem;height:7rem;background-image:url(" + __webpack_require__(295) + ");background-size:100% 100%;background-repeat:no-repeat}.machine .integral-message[data-v-43e37cde]{top:-.53333rem;width:5.54667rem;height:1.13333rem;margin-left:-2.77333rem;background-color:#fdc713;box-shadow:0 .06667rem .06667rem #fbab07;font-size:.50667rem;color:#fff}.machine .integral-message[data-v-43e37cde],.machine .notice[data-v-43e37cde]{display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-justify-content:center;-ms-flex-pack:center;justify-content:center;-webkit-align-items:center;-ms-flex-align:center;align-items:center;position:absolute;left:50%;border-radius:.13333rem;z-index:1}.machine .notice[data-v-43e37cde]{bottom:-.26667rem;width:4.26667rem;height:.84rem;margin-left:-2.13333rem;background-color:#76e6f7;box-shadow:0 .06667rem .06667rem #367fe5;font-weight:500;color:#fc4c60}.machine .notice .number[data-v-43e37cde]{padding:0 .06667rem;font-size:.48rem;color:#fff}.machine .container[data-v-43e37cde]{display:-webkit-flex;display:-ms-flexbox;display:flex;position:relative;background-color:#fff;width:100%;height:100%;border:.4rem solid #fdc713;border-radius:.16rem;box-shadow:0 0 .10667rem rgba(0,0,0,.6)}.machine .shadow[data-v-43e37cde]{position:absolute;left:0;top:0;width:100%;height:100%;z-index:2}.machine .group[data-v-43e37cde]{-webkit-flex:1;-ms-flex:1;flex:1;height:5.33333rem;border-right:.08rem solid #fdc713;overflow:hidden}.machine .group[data-v-43e37cde]:last-child{border:none}.machine .awords[data-v-43e37cde]{position:relative;top:-25%}.machine .awords li[data-v-43e37cde]{display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-justify-content:center;-ms-flex-pack:center;justify-content:center;-webkit-align-items:center;-ms-flex-align:center;align-items:center;height:2.66667rem}.machine .awords img[data-v-43e37cde]{width:2.4rem;height:1.86667rem}.operation[data-v-43e37cde]{position:relative;width:10rem;height:1.84rem;text-align:center;margin-bottom:.53333rem}.operation img[data-v-43e37cde]{position:relative;width:3.24rem;height:1.84rem}.operation .line[data-v-43e37cde]{left:.4rem;width:9.2rem;height:.05333rem}.operation .line[data-v-43e37cde],.operation .line[data-v-43e37cde]:after,.operation .line[data-v-43e37cde]:before{position:absolute;top:50%;background-color:#76e6f7;box-shadow:0 .06667rem .06667rem #4a93f0;-webkit-transform:translateY(-50%);-ms-transform:translateY(-50%);transform:translateY(-50%)}.operation .line[data-v-43e37cde]:after,.operation .line[data-v-43e37cde]:before{content:\"\";width:.18667rem;height:.18667rem;border-radius:50%}.operation .line[data-v-43e37cde]:before{left:-.09333rem}.operation .line[data-v-43e37cde]:after{right:-.09333rem}.describe[data-v-43e37cde]{position:relative;padding:0 .53333rem}.describe .editor-style[data-v-43e37cde]{padding-top:.26667rem;padding-bottom:.53333rem;color:#fff}", ""]);
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../../../../node_modules/css-loader/index.js?minimize&-autoprefixer!../../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-43e37cde&scoped=true!../../../../../node_modules/sass-loader/index.js!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./machine.vue", function() {
			var newContent = require("!!../../../../../node_modules/css-loader/index.js?minimize&-autoprefixer!../../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-43e37cde&scoped=true!../../../../../node_modules/sass-loader/index.js!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./machine.vue");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
module.exports = __webpack_require__.p + "images/machineBackground.6af027fb140156cee66530666c9b1cf4.png";
...
module.exports = __webpack_require__.p + "images/machineButton.67426c7b56199f197c4d049b8c4492de.png";
...
module.exports = "data:image/png;base64,"
...
module.exports = __webpack_require__.p + "images/machineDefaultBanner.5eef089a0aa2ce4d4090d12ebb23ebfc.png";
...
module.exports = __webpack_require__.p + "images/machinePanel.6ac4ba92732d28aadbf2d0cd259b7f4a.png";
...
module.exports = __webpack_require__.p + "images/machineShadow.61789c4451c9b3654395db55aa9ab09b.png";
...
Component.options.__file = "/Users/genesischou/Documents/integral-mall/src/views/activityDetail/components/machine/machine.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] machine.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-43e37cde", Component.options)
  } else {
    hotAPI.reload("data-v-43e37cde", Component.options)
  }
})()}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }), _vm._v(" "), _vm._l((_vm.activityDetail.items), function(aword) {
    return _c('li', [_c('img', {
      attrs: {
        "src": aword.pic
      }
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-43e37cde", module.exports)
  }
}
