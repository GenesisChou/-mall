...
/* harmony default export */ __webpack_exports__["default"] = ({
        ...
        state: function state(value) {
            ...
            if (value === 'start') {
                var _step = function _step() {
                    ...
                    time++;
                    _this.move();
                    setTimeout(_step, interval);
                };

                var result = this.activity_result,
                    _this = this,
                    stop_position = this.stop_position,
                    //停止位置
                move_times = this.getMoveTimes(stop_position),
                    //总循环次数
                speed_min = 500,
                    //最小速度
                speed_max = 20,
                ...
                if (result.is_win) {
                    this.alert = {
                        ...
                        callback_close: function callback_close() {
                            _this2.init(_this2.stop_position);
                        },
                        btn_text: '查看'
                    };
                } else {
    ...
    methods: {
        ...
        getPosition: function getPosition(name) {
            var stop_position = 0;
            this.awards.forEach(function (award, index) {
                if (award.name === name) {
                    stop_position = index;
                    return true;
                }
        ...
        getMoveTimes: function getMoveTimes(stop_position) {
            var step = stop_position - this.current_index;
            if (step < 0) {
...
// module
exports.push([module.i, ".fortune[data-v-56dbf4f6]{min-height:16.66667rem;padding-bottom:1.12rem;background-color:#fdf860;background-image:url(" + __webpack_require__(283) + ");background-size:10rem 18.4rem;background-position:0 5.33333rem;background-repeat:no-repeat}.fortune>header[data-v-56dbf4f6]{margin-bottom:-.8rem}.banner[data-v-56dbf4f6]{width:10rem;height:5.33333rem}.panel[data-v-56dbf4f6]{position:relative;width:8.30667rem;height:10.78667rem;margin:.13333rem auto .26667rem;background-image:url(" + __webpack_require__(285) + ");background-size:100% 100%;background-repeat:no-repeat}.integral-message[data-v-56dbf4f6]{display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-justify-content:center;-ms-flex-pack:center;justify-content:center;-webkit-align-items:center;-ms-flex-align:center;align-items:center;height:1.33333rem;color:#fff;font-size:.50667rem}table[data-v-56dbf4f6]{margin:0 auto;padding-top:.96rem}td[data-v-56dbf4f6]{width:2.37333rem;height:2.37333rem;vertical-align:middle;text-align:center;background-image:url(" + __webpack_require__(286) + ");background-size:2.06667rem 2.06667rem;background-position:50%;background-repeat:no-repeat}td img[data-v-56dbf4f6]{width:1.53333rem;height:1rem;margin-bottom:.13333rem}td.center[data-v-56dbf4f6]{background-size:100% 100%;background-image:url(" + __webpack_require__(288) + ")}td.active[data-v-56dbf4f6]{background-image:url(" + __webpack_require__(287) + ")}td.center.active[data-v-56dbf4f6]{background-image:url(" + __webpack_require__(289) + ")}.notice[data-v-56dbf4f6]{position:absolute;bottom:.2rem;left:50%;-webkit-transform:translateX(-50%);-ms-transform:translateX(-50%);transform:translateX(-50%);text-align:center;color:#b50300}.notice .number[data-v-56dbf4f6]{padding:0 .04rem;color:#ff6;font-size:.45333rem}.describe[data-v-56dbf4f6]{padding:0 .53333rem}.describe .editor-style[data-v-56dbf4f6]{padding-top:.26667rem;padding-bottom:.53333rem;color:#ad0406}", ""]);
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../../../../node_modules/css-loader/index.js?minimize&-autoprefixer!../../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-56dbf4f6&scoped=true!../../../../../node_modules/sass-loader/index.js!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./fortune.vue", function() {
			var newContent = require("!!../../../../../node_modules/css-loader/index.js?minimize&-autoprefixer!../../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-56dbf4f6&scoped=true!../../../../../node_modules/sass-loader/index.js!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./fortune.vue");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
module.exports = __webpack_require__.p + "images/fortuneBackground.f670495679d35ac34271faf6718cf808.png";
...
module.exports = __webpack_require__.p + "images/fortuneDefaultBanner.72d1e45ecceff8596d21720a2d465d19.png";
...
module.exports = __webpack_require__.p + "images/fortunePanel.7645fa0ce072256e3a8b5d7c16ba723d.png";
...
module.exports = "data:image/png;base64,"
...
module.exports = "data:image/png;base64,"
...
module.exports = __webpack_require__.p + "images/fortuneStartButton.90a584d583504c48dccc8263e3bdd0ee.png";
...
module.exports = __webpack_require__.p + "images/fortuneStartButtonActive.ba40bc11207e3cab283eb7bbfc402b2c.png";
...
Component.options.__file = "/Users/genesischou/Documents/integral-mall/src/views/activityDetail/components/fortune/fortune.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] fortune.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-56dbf4f6", Component.options)
  } else {
    hotAPI.reload("data-v-56dbf4f6", Component.options)
  }
})()}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  })], 1), _vm._v(" "), _c('table', [_c('tr', [_c('td', {
    class: {
      active: _vm.current_index == 0
    }
  }, [_c('img', {
    attrs: {
      "src": _vm.awards[0].pic
    }
  })]), _vm._v(" "), _c('td', {
    class: {
      active: _vm.current_index == 1
    }
  }, [_c('img', {
    attrs: {
      "src": _vm.awards[1].pic
    }
  })]), _vm._v(" "), _c('td', {
    class: {
      active: _vm.current_index == 2
    }
  }, [_c('img', {
    attrs: {
      "src": _vm.awards[2].pic
    }
  })])]), _vm._v(" "), _c('tr', [_c('td', {
    class: {
      active: _vm.current_index == 7
    }
  }, [_c('img', {
    attrs: {
      "src": _vm.awards[7].pic
    }
  })]), _vm._v(" "), _c('td', {
    class: ["center", _vm.state == "start" ? "active" : ""],
    on: {
      "click": _vm.start
    }
  }), _vm._v(" "), _c('td', {
    class: {
      active: _vm.current_index == 3
    }
  }, [_c('img', {
    attrs: {
      "src": _vm.awards[3].pic
    }
  })])]), _vm._v(" "), _c('tr', [_c('td', {
    class: {
      active: _vm.current_index == 6
    }
  }, [_c('img', {
    attrs: {
      "src": _vm.awards[6].pic
    }
  })]), _vm._v(" "), _c('td', {
    class: {
      active: _vm.current_index == 5
    }
  }, [_c('img', {
    attrs: {
      "src": _vm.awards[5].pic
    }
  })]), _vm._v(" "), _c('td', {
    class: {
      active: _vm.current_index == 4
    }
  }, [_c('img', {
    attrs: {
      "src": _vm.awards[4].pic
    }
  })])])]), _vm._v(" "), _c('h5', {
    staticClass: "notice"
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-56dbf4f6", module.exports)
  }
}
