...
module.exports = {
    isInArray: function isInArray(name, arr) {
        var result = false;
    ...
    touchBottom: function touchBottom() {
        var utils = this;
    ...
    setSessionStorage: function setSessionStorage(key, obj) {
    ...
    getTimeInterval: function getTimeInterval(date_1, date_2, type) {
    ...
    // 防抖函数
    debounce: function debounce(fn, delay, mustRunDelay) {
        var timer = null,
            t_start = void 0;
        return function () {
            var context = this,
...
var state = {
    ...
    getUserInfor: function getUserInfor(state, callback) {
        _vue2.default.http.post(APP.HOST + '/get_user/' + APP.USER_ID, {
            token: APP.TOKEN,
            userid: APP.USER_ID
    ...
    getAddressList: function getAddressList(state, callback) {
        _vue2.default.http.post(APP.HOST + '/address_list/' + APP.USER_ID, {
            token: APP.TOKEN,
            userid: APP.USER_ID
        }).then(function (response) {
    ...
    pageView: function pageView(state, page_id) {
        _vue2.default.http.post(APP.HOST + '/page_view', {
            token: APP.TOKEN,
            user_id: APP.USER_ID,
            page_id: page_id,
    ...
    bannerView: function bannerView(state, banner_id) {
        _vue2.default.http.post(APP.HOST + '/banner_view', {
            token: APP.TOKEN,
            userid: APP.USER_ID,
            user_id: APP.USER_ID,
            banner_id: banner_id,
    ...
    commendView: function commendView(state, commend_id) {
        _vue2.default.http.post(APP.HOST + '/commend_view', {
            token: APP.TOKEN,
            userid: APP.USER_ID,
            user_id: APP.USER_ID,
    ...
    subjectView: function subjectView(state, subject_id) {
        _vue2.default.http.post(APP.HOST + '/subject_view', {
            token: APP.TOKEN,
            userid: APP.USER_ID,
            user_id: APP.USER_ID,
    ...
    subjectView: function subjectView(_ref9, subject_id) {
...
Component.options.__file = "/Users/genesischou/Documents/integral-mall/src/components/vModal.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-433880ed", Component.options)
  } else {
    hotAPI.reload("data-v-433880ed", Component.options)
  }
})()}
...
var _vSupport = __webpack_require__(40);

var _vSupport2 = _interopRequireDefault(_vSupport);

var _vSimditor = __webpack_require__(39);

var _vSimditor2 = _interopRequireDefault(_vSimditor);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var components = {
    vSimditor: _vSimditor2.default,
    vSupport: _vSupport2.default
};
...
var _weixinJsSdk = __webpack_require__(12);
...
module.exports = function (Vue) {
    ...
    getSignature(url).then(function (data) {
        init(data.data);
    });
    ...
    function init(data) {
        ...
        // //判断当前客户端版本是否支持指定JS接口
        _weixinJsSdk2.default.checkJsApi({
        ...
        _weixinJsSdk2.default.ready(function () {
            ...
            //分享到腾讯微博
            _weixinJsSdk2.default.onMenuShareWeibo({
                // title: '分享给地球的微博', // 分享标题
                // desc: '来自地球的问候', // 分享描述
                link: link, // 分享链接
                imgUrl: imgUrl, // 分享图标
    ...
    function share() {
        Vue.http.post(APP.HOST + '/share/' + APP.USER_ID, {
            ...
            _store2.default.dispatch('getUserInfor');
        });
    }
...
Component.options.__file = "/Users/genesischou/Documents/integral-mall/src/APP.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-3dc4f63e", Component.options)
  } else {
    hotAPI.reload("data-v-3dc4f63e", Component.options)
  }
})()}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_components_vLoading_vue__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_components_vLoading_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_components_vLoading_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_components_vAlert_vue__ = __webpack_require__(61);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_components_vAlert_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_components_vAlert_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_components_vConfirm_vue__ = __webpack_require__(62);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_components_vConfirm_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_components_vConfirm_vue__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    name: 'app',
    components: {
        vLoading: __WEBPACK_IMPORTED_MODULE_0_components_vLoading_vue___default.a,
        vAlert: __WEBPACK_IMPORTED_MODULE_1_components_vAlert_vue___default.a,
        vConfirm: __WEBPACK_IMPORTED_MODULE_2_components_vConfirm_vue___default.a
    },
    created: function created() {
        var _this = this;
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    computed: {
        ...
        msg_second: function msg_second() {
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_components_vSpinner_vue__ = __webpack_require__(65);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_components_vSpinner_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_components_vSpinner_vue__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    name: 'vLoading',
    components: {
        vSpinner: __WEBPACK_IMPORTED_MODULE_0_components_vSpinner_vue___default.a
    },
    computed: {
        show: function show() {
...
"use strict";
/* WEBPACK VAR INJECTION */(function(utils, APP) {
...
if (token) {
    ...
    var _media_id = utils.getParameterByName('id'),
        _cache = utils.getLocalStorage(_media_id);
    //无缓存
    if (!_cache) {
        wxLogin(_media_id);
        console.log('no cache');
        //缓存过期
    } else if (cacheExpire(_cache)) {
        wxLogin(_media_id);
...
function startApp(cache) {
    var VueResource = __webpack_require__(7),
        ...
        FastClick = __webpack_require__(6),
        setWeChatConfig = __webpack_require__(19),
        globalComponents = __webpack_require__(18);
    ...
    _vue2.default.use(globalComponents);
    _vue2.default.http.options.emulateJSON = true; //设置vue-resource post请求参数类型为formdata
    setWeChatConfig(_vue2.default);
...
var router = new _vueRouter2.default({
    ...
    fixList = ['index', 'product_list', 'order_list', 'subject_detail'];
router.beforeEach(function (to, from, next) {
    ...
    _store2.default.dispatch('pageView', to.name);
    next();
});
...
// module
exports.push([module.i, ".v-loading[data-v-0a9d9dfc]{position:fixed;left:50%;top:50%;z-index:100;-webkit-transform:translate(-50%,-50%);-ms-transform:translate(-50%,-50%);transform:translate(-50%,-50%)}", ""]);
...
// module
exports.push([module.i, ".v-support .support[data-v-2bbc53a9]{line-height:1.46667rem;color:#a0a7ad;border-top:1px solid #d4d4d6;text-align:center}.v-support .support.no-border[data-v-2bbc53a9]{border-top:none}.v-support .load-more[data-v-2bbc53a9]{line-height:1.06667rem;color:#a0a7ad;text-align:center;border-top:1px solid #d4d4d6}", ""]);
...
// module
exports.push([module.i, ".v-confirm-content[data-v-2cf74180]{position:fixed;left:50%;top:50%;width:8rem;border-radius:.13333rem;overflow:hidden;text-align:center;margin-left:-4rem;margin-top:-1.82667rem;background-color:#fff;z-index:11}.v-confirm-content .msg[data-v-2cf74180]{display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-justify-content:center;-ms-flex-pack:center;justify-content:center;-webkit-align-items:center;-ms-flex-align:center;align-items:center;-webkit-flex-direction:column;-ms-flex-direction:column;flex-direction:column;height:1.73333rem}.v-confirm-content .btns[data-v-2cf74180]{display:-webkit-flex;display:-ms-flexbox;display:flex;border-top:1px solid #d3d4d6}.v-confirm-content .btn-left[data-v-2cf74180],.v-confirm-content .btn-right[data-v-2cf74180]{display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-justify-content:center;-ms-flex-pack:center;justify-content:center;-webkit-align-items:center;-ms-flex-align:center;align-items:center;-webkit-flex:1;-ms-flex:1;flex:1;height:1.33333rem;font-size:.48rem;text-align:center;text-indent:.16rem;letter-spacing:.16rem}.v-confirm-content .btn-right[data-v-2cf74180]{color:#ff5000}", ""]);
...
// module
exports.push([module.i, ".scale-enter-active{transition:-webkit-transform .2s;transition:transform .2s;transition:transform .2s,-webkit-transform .2s}.scale-enter{-webkit-transform:scale(.8);-ms-transform:scale(.8);transform:scale(.8)}body,html{height:100%;width:100%;border:0;line-height:1.5;margin:0;padding:0;font-size:.34667rem;color:#333}body,html,input,textarea{font-family:PingFangSc-Light,Source Sans Pro,Helvetica Neue,Microsoft Yahei,Arial,sans-serif}input,textarea{background:none;-webkit-appearance:none}input[type=date]{background-color:transparent;filter:alpha(opacity=0)}a,button,input{-webkit-tap-highlight-color:transparent;-webkit-user-modify:read-write-plaintext-only}article,aside,audio,canvas,caption,details,div,figure,footer,header,hgroup,iframe,img,mark,menu,nav,object,section,span,summary,table,tbody,td,tfoot,thead,tr,video{border:0;margin:0;padding:0}a,abbr,address,b,blockquote,cit,code,dd,del,dfn,dl,dt,em,fieldset,h1,h2,h3,h4,h5,h6,hr,i,ins,label,legend,li,ol,p,pre,q,samp,small,strong,sub,sup,ul{border:0;font-size:100%;vertical-align:baseline;margin:0;padding:0}article,aside,audio,canvas,figcaption,figure,figure img,footer,header,hgroup,nav,section,video{display:block}table{border-collapse:separate;border-spacing:0}table caption,table td,table th{text-align:left;vertical-align:middle}a,a:link,a:visited{color:#333;text-decoration:none}a img{border:0}img{vertical-align:middle}:focus{outline:0}*{box-sizing:border-box;-webkit-box-sizing:border-box;-webkit-tap-highlight-color:transparent}textarea{resize:none}select{background-color:#fff}button,input{font-size:.34667rem}h1,h2,h3,h4,h5,h6{font-weight:400}h1{font-size:.48rem}h2{font-size:.42667rem}h3{font-size:.4rem}h4{font-size:.37333rem}h5{font-size:.34667rem}h6{font-size:.32rem}.pull-left{float:left}.pull-right{float:right}.text-ellipsis{overflow:hidden;text-overflow:ellipsis;display:-webkit-box;-webkit-line-clamp:1}img.img-responsive{width:100%;height:100%}.btn{padding:0;height:.66667rem;line-height:.66667rem;border:0;border-radius:.13333rem;font-size:.4rem}.btn-orange{background-color:#ff5000;border-color:#ff5000;color:#fff}.btn-orange:active{background-color:#e64800}.btn-gray{background-color:#b5b5b5;color:#fff}#app{width:100%;height:100%}", ""]);
...
// module
exports.push([module.i, ".v-modal .bg-cover[data-v-433880ed]{position:fixed;left:0;top:0;right:0;bottom:0;background:rgba(0,0,0,.5);z-index:5}.v-modal .content[data-v-433880ed]{position:fixed;left:50%;top:50%;-webkit-transform:translate(-50%,-50%);-ms-transform:translate(-50%,-50%);transform:translate(-50%,-50%);z-index:6}", ""]);
...
// module
exports.push([module.i, ".v-alert-content[data-v-6ab9201c]{position:fixed;left:50%;top:50%;width:8rem;font-size:.37333rem;text-align:center;padding:.26667rem;-webkit-transform:translate(-50%,-50%);-ms-transform:translate(-50%,-50%);transform:translate(-50%,-50%);border-radius:.13333rem;background-color:#fff;z-index:11}.v-alert-content .iconfont[data-v-6ab9201c]{width:.8rem;height:.8rem;font-size:.53333rem;font-weight:700;color:#de443b}.v-alert-content .pic[data-v-6ab9201c]{width:4rem;height:2.8rem}.v-alert-content .msg[data-v-6ab9201c]{padding:.53333rem 0;margin:auto;font-size:.42667rem;text-align:center;width:5.33333rem}.v-alert-content button[data-v-6ab9201c]{width:4rem;height:1.06667rem;margin:0 auto;margin-bottom:.4rem;line-height:1.06667rem;font-size:.4rem}.v-alert-content .close[data-v-6ab9201c]{position:absolute;right:.06667rem;top:.06667rem;font-weight:700;font-size:.53333rem;color:#333}", ""]);
...
// module
exports.push([module.i, ".editor-style[data-v-6c650e26]{text-align:justify}", ""]);
...
// module
exports.push([module.i, ".sk-fading-circle[data-v-88548f4e]{width:1.2rem;height:1.2rem;position:relative}.sk-fading-circle .sk-circle[data-v-88548f4e]{width:100%;height:100%;position:absolute;left:0;top:0}.sk-fading-circle .sk-circle[data-v-88548f4e]:before{content:\"\";display:block;width:15%;height:15%;background-color:#a3a3a3;border-radius:100%;-webkit-animation:sk-circleFadeDelay 1.2s infinite ease-in-out both;animation:sk-circleFadeDelay 1.2s infinite ease-in-out both}.sk-fading-circle .sk-circle2[data-v-88548f4e]{-webkit-transform:rotate(30deg);-ms-transform:rotate(30deg);transform:rotate(30deg)}.sk-fading-circle .sk-circle3[data-v-88548f4e]{-webkit-transform:rotate(60deg);-ms-transform:rotate(60deg);transform:rotate(60deg)}.sk-fading-circle .sk-circle4[data-v-88548f4e]{-webkit-transform:rotate(90deg);-ms-transform:rotate(90deg);transform:rotate(90deg)}.sk-fading-circle .sk-circle5[data-v-88548f4e]{-webkit-transform:rotate(120deg);-ms-transform:rotate(120deg);transform:rotate(120deg)}.sk-fading-circle .sk-circle6[data-v-88548f4e]{-webkit-transform:rotate(150deg);-ms-transform:rotate(150deg);transform:rotate(150deg)}.sk-fading-circle .sk-circle7[data-v-88548f4e]{-webkit-transform:rotate(180deg);-ms-transform:rotate(180deg);transform:rotate(180deg)}.sk-fading-circle .sk-circle8[data-v-88548f4e]{-webkit-transform:rotate(210deg);-ms-transform:rotate(210deg);transform:rotate(210deg)}.sk-fading-circle .sk-circle9[data-v-88548f4e]{-webkit-transform:rotate(240deg);-ms-transform:rotate(240deg);transform:rotate(240deg)}.sk-fading-circle .sk-circle10[data-v-88548f4e]{-webkit-transform:rotate(270deg);-ms-transform:rotate(270deg);transform:rotate(270deg)}.sk-fading-circle .sk-circle11[data-v-88548f4e]{-webkit-transform:rotate(300deg);-ms-transform:rotate(300deg);transform:rotate(300deg)}.sk-fading-circle .sk-circle12[data-v-88548f4e]{-webkit-transform:rotate(330deg);-ms-transform:rotate(330deg);transform:rotate(330deg)}.sk-fading-circle .sk-circle2[data-v-88548f4e]:before{-webkit-animation-delay:-1.1s;animation-delay:-1.1s}.sk-fading-circle .sk-circle3[data-v-88548f4e]:before{-webkit-animation-delay:-1s;animation-delay:-1s}.sk-fading-circle .sk-circle4[data-v-88548f4e]:before{-webkit-animation-delay:-.9s;animation-delay:-.9s}.sk-fading-circle .sk-circle5[data-v-88548f4e]:before{-webkit-animation-delay:-.8s;animation-delay:-.8s}.sk-fading-circle .sk-circle6[data-v-88548f4e]:before{-webkit-animation-delay:-.7s;animation-delay:-.7s}.sk-fading-circle .sk-circle7[data-v-88548f4e]:before{-webkit-animation-delay:-.6s;animation-delay:-.6s}.sk-fading-circle .sk-circle8[data-v-88548f4e]:before{-webkit-animation-delay:-.5s;animation-delay:-.5s}.sk-fading-circle .sk-circle9[data-v-88548f4e]:before{-webkit-animation-delay:-.4s;animation-delay:-.4s}.sk-fading-circle .sk-circle10[data-v-88548f4e]:before{-webkit-animation-delay:-.3s;animation-delay:-.3s}.sk-fading-circle .sk-circle11[data-v-88548f4e]:before{-webkit-animation-delay:-.2s;animation-delay:-.2s}.sk-fading-circle .sk-circle12[data-v-88548f4e]:before{-webkit-animation-delay:-.1s;animation-delay:-.1s}@-webkit-keyframes sk-circleFadeDelay{0%,39%,to{opacity:0}40%{opacity:1}}@keyframes sk-circleFadeDelay{0%,39%,to{opacity:0}40%{opacity:1}}", ""]);
...
// module
exports.push([module.i, "@font-face{font-family:iconfont;src:url(\"//at.alicdn.com/t/font_us8k7v56vod8ia4i.eot\");src:url(\"//at.alicdn.com/t/font_us8k7v56vod8ia4i.eot?#iefix\") format(\"embedded-opentype\"),url(\"//at.alicdn.com/t/font_us8k7v56vod8ia4i.woff\") format(\"woff\"),url(\"//at.alicdn.com/t/font_us8k7v56vod8ia4i.ttf\") format(\"truetype\"),url(\"//at.alicdn.com/t/font_us8k7v56vod8ia4i.svg#iconfont\") format(\"svg\")}.iconfont{font-family:iconfont!important;font-size:16px;font-style:normal;-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale}.icon-plus:before{content:\"\\E600\"}.icon-phone:before{content:\"\\E6C9\"}.icon-solved:before{content:\"\\E61E\"}.icon-close-circle:before{content:\"\\E724\"}.icon-plus-circle:before{content:\"\\E728\"}.icon-error:before{content:\"\\E602\"}.icon-delete:before{content:\"\\E604\"}.icon-location:before{content:\"\\E60A\"}.icon-search:before{content:\"\\E60D\"}.icon-warn:before{content:\"\\E60E\"}.icon-correct-circle-hollow:before{content:\"\\E60F\"}.icon-order:before{content:\"\\E610\"}.icon-arrows-up:before{content:\"\\E614\"}.icon-arrows-down:before{content:\"\\E615\"}.icon-arrows-right:before{content:\"\\E616\"}.icon-arrows-left:before{content:\"\\E617\"}.icon-right:before{content:\"\\E618\"}.icon-order-unsolved:before{content:\"\\E60C\"}.icon-error-circle:before{content:\"\\E61C\"}.icon-correct-circle:before{content:\"\\E64A\"}.icon-edit:before{content:\"\\E611\"}.icon-car:before{content:\"\\E61B\"}", ""]);
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js?minimize&-autoprefixer!../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-0a9d9dfc&scoped=true!../../node_modules/sass-loader/index.js!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./vLoading.vue", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js?minimize&-autoprefixer!../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-0a9d9dfc&scoped=true!../../node_modules/sass-loader/index.js!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./vLoading.vue");
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../../node_modules/css-loader/index.js?minimize&-autoprefixer!../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-2bbc53a9&scoped=true!../../../node_modules/sass-loader/index.js!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./vSupport.vue", function() {
			var newContent = require("!!../../../node_modules/css-loader/index.js?minimize&-autoprefixer!../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-2bbc53a9&scoped=true!../../../node_modules/sass-loader/index.js!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./vSupport.vue");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js?minimize&-autoprefixer!../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-2cf74180&scoped=true!../../node_modules/sass-loader/index.js!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./vConfirm.vue", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js?minimize&-autoprefixer!../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-2cf74180&scoped=true!../../node_modules/sass-loader/index.js!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./vConfirm.vue");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../node_modules/css-loader/index.js?minimize&-autoprefixer!../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-3dc4f63e!../node_modules/sass-loader/index.js!../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./APP.vue", function() {
			var newContent = require("!!../node_modules/css-loader/index.js?minimize&-autoprefixer!../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-3dc4f63e!../node_modules/sass-loader/index.js!../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./APP.vue");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js?minimize&-autoprefixer!../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-433880ed&scoped=true!../../node_modules/sass-loader/index.js!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./vModal.vue", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js?minimize&-autoprefixer!../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-433880ed&scoped=true!../../node_modules/sass-loader/index.js!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./vModal.vue");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js?minimize&-autoprefixer!../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-6ab9201c&scoped=true!../../node_modules/sass-loader/index.js!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./vAlert.vue", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js?minimize&-autoprefixer!../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-6ab9201c&scoped=true!../../node_modules/sass-loader/index.js!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./vAlert.vue");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../../node_modules/css-loader/index.js?minimize&-autoprefixer!../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-6c650e26&scoped=true!../../../node_modules/sass-loader/index.js!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./vSimditor.vue", function() {
			var newContent = require("!!../../../node_modules/css-loader/index.js?minimize&-autoprefixer!../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-6c650e26&scoped=true!../../../node_modules/sass-loader/index.js!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./vSimditor.vue");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js?minimize&-autoprefixer!../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-88548f4e&scoped=true!../../node_modules/sass-loader/index.js!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./vSpinner.vue", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js?minimize&-autoprefixer!../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-88548f4e&scoped=true!../../node_modules/sass-loader/index.js!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./vSpinner.vue");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
Component.options.__file = "/Users/genesischou/Documents/integral-mall/src/components/vAlert.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-6ab9201c", Component.options)
  } else {
    hotAPI.reload("data-v-6ab9201c", Component.options)
  }
})()}
...
Component.options.__file = "/Users/genesischou/Documents/integral-mall/src/components/vConfirm.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] vConfirm.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-2cf74180", Component.options)
  } else {
    hotAPI.reload("data-v-2cf74180", Component.options)
  }
})()}
...
Component.options.__file = "/Users/genesischou/Documents/integral-mall/src/components/vLoading.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] vLoading.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-0a9d9dfc", Component.options)
  } else {
    hotAPI.reload("data-v-0a9d9dfc", Component.options)
  }
})()}
...
Component.options.__file = "/Users/genesischou/Documents/integral-mall/src/components/vSimditor/vSimditor.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] vSimditor.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-6c650e26", Component.options)
  } else {
    hotAPI.reload("data-v-6c650e26", Component.options)
  }
})()}
...
Component.options.__file = "/Users/genesischou/Documents/integral-mall/src/components/vSpinner.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] vSpinner.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-88548f4e", Component.options)
  } else {
    hotAPI.reload("data-v-88548f4e", Component.options)
  }
})()}
...
Component.options.__file = "/Users/genesischou/Documents/integral-mall/src/components/vSupport/vSupport.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] vSupport.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-2bbc53a9", Component.options)
  } else {
    hotAPI.reload("data-v-2bbc53a9", Component.options)
  }
})()}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-0a9d9dfc", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._v("上滑加载更多")]), _vm._v(" "), _c('h4', {
    class: ["support", {
      "no-border": _vm.busy
    }]
  }, [_vm._v(" 由" + _vm._s(_vm.name) + "提供技术支持 ")])])
},staticRenderFns: []}
module.exports.render._withStripped = true
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-2bbc53a9", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('v-modal', {
    ...
    staticClass: "msg"
  }, [_c('h3', [_vm._v(_vm._s(_vm.msg))]), _vm._v(" "), (_vm.msg_second) ? _c('h3', [_vm._v(_vm._s(_vm.msg_second))]) : _vm._e()]), _vm._v(" "), _c('div', {
    staticClass: "btns"
  }, [_c('div', {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-2cf74180", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    attrs: {
      "exclude": "myAccount,activityDetail,productDetail,orderDetail,editUser"
    }
  }, [_c('router-view')], 1), _vm._v(" "), _c('v-alert'), _vm._v(" "), _c('v-confirm'), _vm._v(" "), _c('v-loading')], 1)
},staticRenderFns: []}
module.exports.render._withStripped = true
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-3dc4f63e", module.exports)
  }
}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-433880ed", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('v-modal', {
    ...
    class: ["iconfont", _vm.icon_class]
  }), _vm._v(" "), (_vm.msg) ? _c('h3', {
    staticClass: "msg"
  }, [_vm._v(_vm._s(_vm.msg))]) : _vm._e(), _vm._v(" "), _c('button', {
  ...
  }, [_vm._v(_vm._s(_vm.btn_text))]), _vm._v(" "), (_vm.close_btn) ? _c('i', {
    staticClass: "close iconfont icon-error-circle",
    on: {
      "click": function($event) {
        _vm.close()
      }
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-6ab9201c", module.exports)
  }
}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-6c650e26", module.exports)
  }
}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-88548f4e", module.exports)
  }
}
