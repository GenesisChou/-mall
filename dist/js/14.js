...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    watch: {
                ...
                setTimeout(function () {
                    ...
                    setTimeout(function () {
                        _this.timer = setInterval(function () {
                            _this.light_num = ++_this.light_num % (_this.card_num + 1) || 1;
                        }, 600);
                    }, 1500);
                }, 500);
            } else if (value === 'start') {
        ...
        is_win: function is_win(value) {
            ...
            setTimeout(function () {
                _this2.big_card_state = '';
                setTimeout(function () {
                    _this2.big_card_state = 'rotate';
                    setTimeout(function () {
                        _this2.big_show = false;
                        _this2.toggleDialog(_this2.dialog);
                    }, 400);
                }, 50);
            }, 1600);
        }
...
// module
exports.push([module.i, ".v-card[data-v-77064d7e]{min-height:16.66667rem;padding-bottom:1.12rem;background-image:url(" + __webpack_require__(272) + ");background-size:10rem .2rem}.v-card>header[data-v-77064d7e]{margin-bottom:-.34667rem}.background-top[data-v-77064d7e]{position:absolute;left:0;top:0;z-index:0;width:10rem;height:16.66667rem;background-image:url(" + __webpack_require__(273) + ");background-size:10rem .2rem}.decoration[data-v-77064d7e]{position:absolute}.header[data-v-77064d7e]{position:relative;width:10rem;height:5.33333rem}.main[data-v-77064d7e]{position:relative;padding:0 .53333rem;height:10.49333rem;margin-top:.26667rem}.hands[data-v-77064d7e]{position:absolute;left:0;top:3.33333rem;width:10rem;height:7.10667rem}.integral-message[data-v-77064d7e]{display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-justify-content:center;-ms-flex-pack:center;justify-content:center;-webkit-align-items:center;-ms-flex-align:center;align-items:center;position:relative;width:5.49333rem;height:1.10667rem;margin:0 auto;background-color:#e63805;box-shadow:0 .06667rem .06667rem rgba(0,0,0,.2);border-radius:.13333rem;color:#fff;font-size:.50667rem}.cards[data-v-77064d7e]{position:relative;height:7.13333rem;margin-top:.4rem;list-style:none}.card[data-v-77064d7e]{position:absolute;top:3.81333rem;left:6.2rem;width:2.72rem;height:3.26667rem;background-image:url(" + __webpack_require__(271) + ");background-repeat:no-repeat;background-size:100%;list-style:none;transition:.2s}.card.light[data-v-77064d7e]{background-image:url(" + __webpack_require__(277) + ");-webkit-transform:translate(.01333rem,.01333rem);-ms-transform:translate(.01333rem,.01333rem);transform:translate(.01333rem,.01333rem)}.card.move[data-v-77064d7e]:first-child{-webkit-animation:move-one .3s linear forwards;animation:move-one .3s linear forwards}.card.move[data-v-77064d7e]:nth-child(2){-webkit-animation:move-two .3s linear .4s forwards;animation:move-two .3s linear .4s forwards}.card.move[data-v-77064d7e]:nth-child(3){-webkit-animation:move-three .3s linear .8s forwards;animation:move-three .3s linear .8s forwards}.card.move[data-v-77064d7e]:nth-child(4){-webkit-animation:move-four .3s linear 1.2s forwards;animation:move-four .3s linear 1.2s forwards}.card.move[data-v-77064d7e]:nth-child(5){-webkit-animation:move-five .3s forwards;animation:move-five .3s forwards}.card.select[data-v-77064d7e]{z-index:3}.card.select[data-v-77064d7e]:first-child{-webkit-animation:select-one .2s linear forwards;animation:select-one .2s linear forwards}.card.select[data-v-77064d7e]:nth-child(2){-webkit-animation:select-two .2s linear forwards;animation:select-two .2s linear forwards}.card.select[data-v-77064d7e]:nth-child(3){-webkit-animation:select-three .2s linear forwards;animation:select-three .2s linear forwards}.card.select[data-v-77064d7e]:nth-child(4){-webkit-animation:select-four .2s linear forwards;animation:select-four .2s linear forwards}.card.select[data-v-77064d7e]:nth-child(5){-webkit-animation:select-five .2s linear forwards;animation:select-five .2s linear forwards}@-webkit-keyframes move-one{to{top:0;left:1.54667rem}}@keyframes move-one{to{top:0;left:1.54667rem}}@-webkit-keyframes move-two{to{top:0;left:4.64rem}}@keyframes move-two{to{top:0;left:4.64rem}}@-webkit-keyframes move-three{to{top:3.81333rem;left:0}}@keyframes move-three{to{top:3.81333rem;left:0}}@-webkit-keyframes move-four{to{top:3.81333rem;left:3.09333rem}}@keyframes move-four{to{top:3.81333rem;left:3.09333rem}}@-webkit-keyframes move-five{to{top:3.81333rem;left:6.2rem}}@keyframes move-five{to{top:3.81333rem;left:6.2rem}}@-webkit-keyframes select-one{0%{top:0;left:1.54667rem}to{top:50%;left:50%;margin-left:-1.36rem;margin-top:-1.63333rem;opacity:0}}@keyframes select-one{0%{top:0;left:1.54667rem}to{top:50%;left:50%;margin-left:-1.36rem;margin-top:-1.63333rem;opacity:0}}@-webkit-keyframes select-two{0%{top:0;left:4.64rem}to{top:50%;left:50%;margin-left:-1.36rem;margin-top:-1.63333rem;opacity:0}}@keyframes select-two{0%{top:0;left:4.64rem}to{top:50%;left:50%;margin-left:-1.36rem;margin-top:-1.63333rem;opacity:0}}@-webkit-keyframes select-three{0%{top:3.81333rem;left:0}to{top:50%;left:50%;margin-left:-1.36rem;margin-top:-1.63333rem;opacity:0}}@keyframes select-three{0%{top:3.81333rem;left:0}to{top:50%;left:50%;margin-left:-1.36rem;margin-top:-1.63333rem;opacity:0}}@-webkit-keyframes select-four{0%{top:3.81333rem;left:3.09333rem}to{top:50%;left:50%;margin-left:-1.36rem;margin-top:-1.63333rem;opacity:0}}@keyframes select-four{0%{top:3.81333rem;left:3.09333rem}to{top:50%;left:50%;margin-left:-1.36rem;margin-top:-1.63333rem;opacity:0}}@-webkit-keyframes select-five{0%{top:3.81333rem;left:6.2rem}to{top:50%;left:50%;margin-left:-1.36rem;margin-top:-1.63333rem;opacity:0}}@keyframes select-five{0%{top:3.81333rem;left:6.2rem}to{top:50%;left:50%;margin-left:-1.36rem;margin-top:-1.63333rem;opacity:0}}.card.big[data-v-77064d7e]{position:absolute;left:50%;top:50%;z-index:4;width:4.08rem;height:4.9rem;margin-left:-2.04rem;margin-top:-2.45rem;transition:.4s linear}.card.big.shake[data-v-77064d7e]{-webkit-animation:shake .8s linear;animation:shake .8s linear;-webkit-animation-iteration-count:infinite;animation-iteration-count:infinite}.card.big.rotate[data-v-77064d7e]{-webkit-transform:rotateY(-45deg);transform:rotateY(-45deg)}@-webkit-keyframes shake{50%{-webkit-transform:rotate(0deg);transform:rotate(0deg)}56.25%{-webkit-transform:rotate(-10deg);transform:rotate(-10deg)}62.5%{-webkit-transform:rotate(0deg);transform:rotate(0deg)}68.75%{-webkit-transform:rotate(10deg);transform:rotate(10deg)}75%{-webkit-transform:rotate(0deg);transform:rotate(0deg)}81.25%{-webkit-transform:rotate(-10deg);transform:rotate(-10deg)}87.5%{-webkit-transform:rotate(0deg);transform:rotate(0deg)}93.75%{-webkit-transform:rotate(10deg);transform:rotate(10deg)}to{-webkit-transform:rotate(0deg);transform:rotate(0deg)}}@keyframes shake{50%{-webkit-transform:rotate(0deg);transform:rotate(0deg)}56.25%{-webkit-transform:rotate(-10deg);transform:rotate(-10deg)}62.5%{-webkit-transform:rotate(0deg);transform:rotate(0deg)}68.75%{-webkit-transform:rotate(10deg);transform:rotate(10deg)}75%{-webkit-transform:rotate(0deg);transform:rotate(0deg)}81.25%{-webkit-transform:rotate(-10deg);transform:rotate(-10deg)}87.5%{-webkit-transform:rotate(0deg);transform:rotate(0deg)}93.75%{-webkit-transform:rotate(10deg);transform:rotate(10deg)}to{-webkit-transform:rotate(0deg);transform:rotate(0deg)}}.cover[data-v-77064d7e]{position:fixed;left:0;top:0;width:100%;height:100%;background-color:rgba(0,0,0,.5);z-index:2}.notice[data-v-77064d7e]{position:absolute;left:50%;bottom:.73333rem;min-width:3.32rem;margin:0 auto;padding:0 .26667rem;height:.74667rem;font-weight:500;background-color:#ff9c01;box-shadow:0 .06667rem .06667rem rgba(0,0,0,.2);border-radius:.13333rem;color:#fff;-ms-transform:translateX(-50%);transform:translateX(-50%);-webkit-transform:translateX(-50%)}.notice>div[data-v-77064d7e]{display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-justify-content:center;-ms-flex-pack:center;justify-content:center;-webkit-align-items:center;-ms-flex-align:center;align-items:center}.notice .number[data-v-77064d7e]{padding:0 .13333rem;color:#e63805;font-size:.58667rem}.describe[data-v-77064d7e]{position:relative;padding:0 .53333rem;background-image:url(" + __webpack_require__(274) + ");background-repeat:no-repeat;background-size:10rem 1.12rem}.describe .editor-style[data-v-77064d7e]{padding-top:.26667rem;padding-bottom:.53333rem;color:#fff}", ""]);
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../../../../node_modules/css-loader/index.js?minimize&-autoprefixer!../../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-77064d7e&scoped=true!../../../../../node_modules/sass-loader/index.js!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./card.vue", function() {
			var newContent = require("!!../../../../../node_modules/css-loader/index.js?minimize&-autoprefixer!../../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-77064d7e&scoped=true!../../../../../node_modules/sass-loader/index.js!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./card.vue");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
module.exports = "data:image/png;base64,"
...
module.exports = "data:image/png;base64,"
...
module.exports = "data:image/png;base64,"
...
module.exports = __webpack_require__.p + "images/cardDecoration.86150b7a3ffa15cb71b731882a139646.png";
...
module.exports = __webpack_require__.p + "images/cardDefaultBanner.151d3f95df1d6392693cfcf789705bb4.png";
...
module.exports = __webpack_require__.p + "images/cardHands.9182d14b5bde0004ad3713c1fab59e92.png";
...
module.exports = __webpack_require__.p + "images/cardLight.a3990d0c37c20be12a7f8173023920bb.png";
...
Component.options.__file = "/Users/genesischou/Documents/integral-mall/src/views/activityDetail/components/card/card.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-77064d7e", Component.options)
  } else {
    hotAPI.reload("data-v-77064d7e", Component.options)
  }
})()}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "background-top"
  }), _vm._v(" "), _vm._m(0), _vm._v(" "), _c('main', {
    staticClass: "main"
  }, [_c('div', {
    ...
    return _c('li', {
      class: ["card", {
        ...
        light: _vm.light_num == i
      }, {
        select: _vm.select_num == i
      }],
      on: {
    ...
    class: ["card", "big", _vm.big_card_state],
    attrs: {
      "transition": "display"
    }
  })], 2), _vm._v(" "), _c('div', {
    staticClass: "notice"
  }, [_c('div', [(_vm.freeTimes > 0) ? [_vm._v("\n                    今天还有"), _c('strong', {
    staticClass: "number"
    ...
    directives: [{
      name: "show",
      rawName: "v-show",
      value: (_vm.cover_show),
      expression: "cover_show"
    }],
    staticClass: "cover"
  }), _vm._v(" "), _c('article', {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-77064d7e", module.exports)
  }
}
