...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_people__ = __webpack_require__(185);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_people___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__components_people__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    components: {
        ...
        vPeople: __WEBPACK_IMPORTED_MODULE_3__components_people___default.a
    },
    props: {
    ...
    watch: {
        state: function state(value) {
            ...
            if (value === 'stop') {
                ...
                setTimeout(function () {
                    _this.chests[_this.random].style.visibility = 'hidden';
                    _this.state = 'stop';
                }, time);
            }
        },
...
// module
exports.push([module.i, ".v-treasure[data-v-3e176abe]{min-height:16.66667rem;padding-bottom:1.12rem;overflow:hidden;background-color:#00627f;background-image:url(" + __webpack_require__(323) + ");background-size:10rem 22.28rem;background-repeat:no-repeat;background-position:0 6.2rem}.header[data-v-3e176abe]{position:relative;width:10rem;height:5.33333rem}.banner[data-v-3e176abe]{position:absolute;width:100%;height:100%;z-index:0}.wave[data-v-3e176abe]{position:absolute;left:-.18667rem;bottom:-1rem;width:10.18667rem;height:1.44rem;z-index:2;-webkit-animation:wave 5s linear infinite;animation:wave 5s linear infinite;-webkit-transform:translateY(3%);-ms-transform:translateY(3%);transform:translateY(3%)}@-webkit-keyframes wave{50%{-webkit-transform:translateY(-3%) translateX(.18667rem);transform:translateY(-3%) translateX(.18667rem)}to{-webkit-transform:translateY(3%);transform:translateY(3%)}}@keyframes wave{50%{-webkit-transform:translateY(-3%) translateX(.18667rem);transform:translateY(-3%) translateX(.18667rem)}to{-webkit-transform:translateY(3%);transform:translateY(3%)}}.container[data-v-3e176abe]{position:relative;width:10rem;height:7.77333rem;margin-top:1.06667rem}.chest[data-v-3e176abe]{position:absolute;width:1.8rem;height:1.76rem;background-image:url(" + __webpack_require__(322) + ");background-size:100%;background-repeat:no-repeat;z-index:1;-webkit-transform-origin:left top;-ms-transform-origin:left top;transform-origin:left top;-webkit-animation:chest 5s linear infinite;animation:chest 5s linear infinite}.chest[data-v-3e176abe]:first-child{left:.26667rem;top:4.26667rem;opacity:.7}.chest[data-v-3e176abe]:nth-child(2){left:1.06667rem;top:1.6rem;-webkit-animation-delay:-1s;animation-delay:-1s}.chest[data-v-3e176abe]:nth-child(3){left:3.2rem;top:.26667rem;width:1.6rem;height:1.568rem;opacity:.7;-webkit-animation-delay:-3.4s;animation-delay:-3.4s}.chest[data-v-3e176abe]:nth-child(4){left:2.8rem;top:3.33333rem;-webkit-animation-delay:-3.8s;animation-delay:-3.8s}.chest[data-v-3e176abe]:nth-child(5){left:5.73333rem;top:.93333rem;width:1.6rem;height:1.568rem;opacity:.7;-webkit-animation-delay:-1.2s;animation-delay:-1.2s}.chest[data-v-3e176abe]:nth-child(6){left:5rem;top:1.46667rem;width:2rem;height:1.96rem;-webkit-animation-delay:-2.4s;animation-delay:-2.4s}.chest[data-v-3e176abe]:nth-child(7){left:7.46667rem;top:3.33333rem;width:2rem;height:1.96rem;-webkit-animation-delay:-4.6s;animation-delay:-4.6s}.chest[data-v-3e176abe]:nth-child(8){left:8rem;top:.26667rem;width:1.6rem;height:1.568rem;-webkit-animation-delay:-1.2s;animation-delay:-1.2s}@-webkit-keyframes chest{0%{-webkit-transform:translateY(0);transform:translateY(0)}25%{-webkit-transform:translateY(-7%);transform:translateY(-7%)}50%{-webkit-transform:translateY(0);transform:translateY(0)}75%{-webkit-transform:translateY(7%);transform:translateY(7%)}to{-webkit-transform:translateY(0);transform:translateY(0)}}@keyframes chest{0%{-webkit-transform:translateY(0);transform:translateY(0)}25%{-webkit-transform:translateY(-7%);transform:translateY(-7%)}50%{-webkit-transform:translateY(0);transform:translateY(0)}75%{-webkit-transform:translateY(7%);transform:translateY(7%)}to{-webkit-transform:translateY(0);transform:translateY(0)}}.buble[data-v-3e176abe]{position:relative;width:7.10667rem;height:3.50667rem;margin-top:2rem;z-index:2;opacity:.2;-webkit-animation:buble 7s linear infinite;animation:buble 7s linear infinite}@-webkit-keyframes buble{10%{opacity:.5}25%{opacity:1;-webkit-transform:translateY(-10%) translateX(1%);transform:translateY(-10%) translateX(1%)}50%{opacity:1;-webkit-transform:translateY(-17%) translateX(0);transform:translateY(-17%) translateX(0)}75%{opacity:1;-webkit-transform:translateY(-24%) translateX(-1%);transform:translateY(-24%) translateX(-1%)}to{opacity:0;-webkit-transform:translateY(-30%) translateX(0);transform:translateY(-30%) translateX(0)}}@keyframes buble{10%{opacity:.5}25%{opacity:1;-webkit-transform:translateY(-10%) translateX(1%);transform:translateY(-10%) translateX(1%)}50%{opacity:1;-webkit-transform:translateY(-17%) translateX(0);transform:translateY(-17%) translateX(0)}75%{opacity:1;-webkit-transform:translateY(-24%) translateX(-1%);transform:translateY(-24%) translateX(-1%)}to{opacity:0;-webkit-transform:translateY(-30%) translateX(0);transform:translateY(-30%) translateX(0)}}.notice[data-v-3e176abe]{position:absolute;bottom:1rem;left:50%;text-align:center;width:4.13333rem;height:1.04rem;margin-left:-2.06667rem;background-image:url(" + __webpack_require__(326) + ");background-size:100% 100%;font-weight:500;color:#89deee}.notice .number[data-v-3e176abe]{padding:0 .13333rem;font-size:.50667rem;color:#fff}.operation[data-v-3e176abe]{display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-justify-content:center;-ms-flex-pack:center;justify-content:center;position:relative;width:10rem;height:1.84rem;text-align:center;margin-bottom:.53333rem}.operation img[data-v-3e176abe]{position:relative;width:3.24rem;height:1.84rem;margin-left:1.33333rem;z-index:1}.operation .integral-message[data-v-3e176abe]{display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-justify-content:center;-ms-flex-pack:center;justify-content:center;-webkit-align-items:center;-ms-flex-align:center;align-items:center;-webkit-flex-direction:column;-ms-flex-direction:column;flex-direction:column;position:relative;width:3.24rem;height:1.73333rem;background-color:#008198;border-radius:.26667rem;box-shadow:0 .10667rem 0 #156872;color:#fff;font-size:.50667rem;z-index:1}.operation .line[data-v-3e176abe]{left:.4rem;width:9.2rem;height:.05333rem;z-index:0}.operation .line[data-v-3e176abe],.operation .line[data-v-3e176abe]:after,.operation .line[data-v-3e176abe]:before{position:absolute;top:50%;background-color:#76e6f7;box-shadow:0 .06667rem .06667rem #4a93f0;-webkit-transform:translateY(-50%);-ms-transform:translateY(-50%);transform:translateY(-50%)}.operation .line[data-v-3e176abe]:after,.operation .line[data-v-3e176abe]:before{content:\"\";width:.18667rem;height:.18667rem;border-radius:50%}.operation .line[data-v-3e176abe]:before{left:-.09333rem}.operation .line[data-v-3e176abe]:after{right:-.09333rem}.describe[data-v-3e176abe]{padding:0 .53333rem}.describe .editor-style[data-v-3e176abe]{padding-top:.26667rem;padding-bottom:.53333rem;color:#fff}", ""]);
...
// module
exports.push([module.i, ".ship[data-v-67c23970]{position:absolute;left:-1.06667rem;bottom:-1.46667rem;width:5.05333rem;height:3.52rem;z-index:1}.people[data-v-67c23970]{position:absolute;left:0;bottom:-1.30667rem;width:2.49333rem;height:4.25333rem;z-index:3}@-webkit-keyframes ship{0%{-webkit-transform:translateY(0);transform:translateY(0)}50%{-webkit-transform:translateY(-3%);transform:translateY(-3%)}to{-webkit-transform:translateY(0);transform:translateY(0)}}@keyframes ship{0%{-webkit-transform:translateY(0);transform:translateY(0)}50%{-webkit-transform:translateY(-3%);transform:translateY(-3%)}to{-webkit-transform:translateY(0);transform:translateY(0)}}.net[data-v-67c23970]{position:absolute;left:1.64rem;bottom:.42667rem;width:5.33333rem;height:.06667rem;background-color:#831a27;z-index:3;-webkit-transform-origin:left;-ms-transform-origin:left;transform-origin:left}.net[data-v-67c23970]:before{content:\"\";position:absolute;right:-1.66667rem;top:-.37333rem;width:1.66667rem;height:1.72rem;background-image:url(" + __webpack_require__(318) + ");background-size:100% 100%}.net[data-v-67c23970]:after{content:\"\";position:absolute;right:0;top:50%;width:.16rem;height:.16rem;margin-top:-.08rem;border-radius:50%;background-color:#831a27}.net.ready[data-v-67c23970]{-webkit-animation:ready 1.5s linear infinite;animation:ready 1.5s linear infinite}.net.one[data-v-67c23970]{-webkit-animation:one 1s ease-in forwards;animation:one 1s ease-in forwards}.net.two[data-v-67c23970]{width:3.06667rem;-webkit-animation:two 1s ease-in forwards;animation:two 1s ease-in forwards}@-webkit-keyframes ready{0%{width:2.66667rem}50%{width:5.33333rem}to{width:2.66667rem}}@keyframes ready{0%{width:2.66667rem}50%{width:5.33333rem}to{width:2.66667rem}}@-webkit-keyframes one{0%{-webkit-transform:rotateX(180deg);transform:rotateX(180deg)}to{-webkit-transform:rotateX(180deg) rotate(-80deg);transform:rotateX(180deg) rotate(-80deg)}}@keyframes one{0%{-webkit-transform:rotateX(180deg);transform:rotateX(180deg)}to{-webkit-transform:rotateX(180deg) rotate(-80deg);transform:rotateX(180deg) rotate(-80deg)}}@-webkit-keyframes two{0%{-webkit-transform:rotateX(180deg);transform:rotateX(180deg)}to{-webkit-transform:rotateX(180deg) rotate(-100deg);transform:rotateX(180deg) rotate(-100deg)}}@keyframes two{0%{-webkit-transform:rotateX(180deg);transform:rotateX(180deg)}to{-webkit-transform:rotateX(180deg) rotate(-100deg);transform:rotateX(180deg) rotate(-100deg)}}", ""]);
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../../../../node_modules/css-loader/index.js?minimize&-autoprefixer!../../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-3e176abe&scoped=true!../../../../../node_modules/sass-loader/index.js!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./treasure.vue", function() {
			var newContent = require("!!../../../../../node_modules/css-loader/index.js?minimize&-autoprefixer!../../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-3e176abe&scoped=true!../../../../../node_modules/sass-loader/index.js!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./treasure.vue");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../../../../../../node_modules/css-loader/index.js?minimize&-autoprefixer!../../../../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-67c23970&scoped=true!../../../../../../../node_modules/sass-loader/index.js!../../../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./people.vue", function() {
			var newContent = require("!!../../../../../../../node_modules/css-loader/index.js?minimize&-autoprefixer!../../../../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-67c23970&scoped=true!../../../../../../../node_modules/sass-loader/index.js!../../../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./people.vue");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
module.exports = __webpack_require__.p + "images/net.e6d514b0ba92364a98e44340ef63ca85.png";
...
module.exports = __webpack_require__.p + "images/ship.d94b8802c2ddd2a7d27521fdabd9f726.png";
...
module.exports = __webpack_require__.p + "images/treasurePeople.5b0ab2d6799ec30ef8a3fe2c62b95dc6.png";
...
module.exports = "data:image/png;base64,"
...
module.exports = __webpack_require__.p + "images/chest.1759ce5a6cd8b528ef1f632fc7c6106e.png";
...
module.exports = __webpack_require__.p + "images/treasureBackground.b5a7c0cc0cd477351d7ef3bd2147761e.png";
...
module.exports = __webpack_require__.p + "images/treasureButton.e87e9bd42eb557bbb8f16631c148a93f.png";
...
module.exports = __webpack_require__.p + "images/treasureDefaultBanner.b178abf32d452429195007e81fef187b.png";
...
module.exports = "data:image/png;base64,"
...
module.exports = __webpack_require__.p + "images/wave.d3696563eb60a8d55f6f53dfa20c8b6e.png";
...
Component.options.__file = "/Users/genesischou/Documents/integral-mall/src/views/activityDetail/components/treasure/components/people/people.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-67c23970", Component.options)
  } else {
    hotAPI.reload("data-v-67c23970", Component.options)
  }
})()}
...
Component.options.__file = "/Users/genesischou/Documents/integral-mall/src/views/activityDetail/components/treasure/treasure.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] treasure.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-3e176abe", Component.options)
  } else {
    hotAPI.reload("data-v-3e176abe", Component.options)
  }
})()}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-3e176abe", module.exports)
  }
}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-67c23970", module.exports)
  }
}
