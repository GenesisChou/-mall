...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    watch: {
        state: function state(value) {
            ...
            if (value == 'ready') {
                this.timer = setInterval(function () {
                    _this.active_num = ++_this.active_num % (_this.egg_number + 1) || 1;
                }, 600);
            } else if (value == 'start') {
                this.active_num = 0;
        ...
        broken_num: function broken_num(value, old_value) {
            var _this2 = this;
            ...
            if (value) {
                ...
                setTimeout(function () {
                    _this2.hammer.classList.toggle('active');
                    var time = 0;
                    var timer = setInterval(function () {
                        _this2.eggs[value - 1].classList.toggle('broken');
                        if (++time >= 3) {
                            clearInterval(timer);
                            _this2.hammer.classList.toggle('active');
                        }
            ...
            setTimeout(function () {
                if (value) {
                    _this3.toggleDialog({
                        ...
                        msg: '获得' + result.name,
                        callback: _this3.toOrderDetail(result.id),
        ...
        start: function start(num) {
            ...
            this.$http.post(APP.HOST + '/smashing_eggs_activity/' + this.id, {
                ...
                if (data.status == APP.SUCCESS) {
                    _this4.broken_num = num;
                    _this4.activity_result = data.data;
                    _this4.is_win = _this4.activity_result.is_win;
                } else {
                    _this4.toggleDialog({
                        msg: data.info,
                        callback: function callback() {
...
// module
exports.push([module.i, ".v-egg[data-v-2f22dbe6]{min-height:16.66667rem;padding-bottom:1.12rem;background-color:#fdf860}.header[data-v-2f22dbe6]{width:10rem;height:5.33333rem}.main[data-v-2f22dbe6]{position:relative}.integral-message[data-v-2f22dbe6]{display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-justify-content:center;-ms-flex-pack:center;justify-content:center;-webkit-align-items:center;-ms-flex-align:center;align-items:center;width:5.49333rem;height:1.10667rem;margin:0 auto;background-color:#c92426;border-radius:.13333rem;color:#fff;font-size:.50667rem}.eggs[data-v-2f22dbe6]{display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-flex-wrap:wrap;-ms-flex-wrap:wrap;flex-wrap:wrap;position:relative;margin-top:.66667rem}.eggs li[data-v-2f22dbe6]{position:relative;width:3.33333rem;height:3.33333rem;list-style:none;background-image:url(" + __webpack_require__(279) + ");background-size:2.69333rem 2.66667rem;background-position:50%;background-repeat:no-repeat}.eggs li.active[data-v-2f22dbe6]{-webkit-transform:translateY(-20%);-ms-transform:translateY(-20%);transform:translateY(-20%)}.eggs li.broken[data-v-2f22dbe6]{background-image:url(" + __webpack_require__(278) + ")}.eggs .hammer[data-v-2f22dbe6]{position:absolute;width:1.44rem;height:1.16rem;top:-2rem;left:8.56rem;transition:1s linear;-webkit-transform-origin:right bottom;-ms-transform-origin:right bottom;transform-origin:right bottom}.eggs .hammer.active[data-v-2f22dbe6]{-webkit-animation:hammer 1s linear infinite;animation:hammer 1s linear infinite}.notice[data-v-2f22dbe6]{padding-top:.2rem;text-align:center;font-weight:500;color:#ad0406}.notice .number[data-v-2f22dbe6]{padding:0 .04rem;color:#ff494b;font-size:.48rem}.describe[data-v-2f22dbe6]{position:relative;padding:.66667rem .53333rem 0}.describe .editor-style[data-v-2f22dbe6]{padding-top:.26667rem;padding-bottom:.53333rem;color:#ad0406}.background[data-v-2f22dbe6]{position:absolute;left:0;top:4.26667rem;width:10rem;height:12.37333rem;z-index:0}@-webkit-keyframes hammer{0%{-webkit-transform:rotate(0deg);transform:rotate(0deg)}25%{-webkit-transform:rotate(30deg);transform:rotate(30deg)}50%{-webkit-transform:rotate(0deg);transform:rotate(0deg)}75%{-webkit-transform:rotate(30deg);transform:rotate(30deg)}to{-webkit-transform:rotate(0deg);transform:rotate(0deg)}}@keyframes hammer{0%{-webkit-transform:rotate(0deg);transform:rotate(0deg)}25%{-webkit-transform:rotate(30deg);transform:rotate(30deg)}50%{-webkit-transform:rotate(0deg);transform:rotate(0deg)}75%{-webkit-transform:rotate(30deg);transform:rotate(30deg)}to{-webkit-transform:rotate(0deg);transform:rotate(0deg)}}", ""]);
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../../../../node_modules/css-loader/index.js?minimize&-autoprefixer!../../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-2f22dbe6&scoped=true!../../../../../node_modules/sass-loader/index.js!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./egg.vue", function() {
			var newContent = require("!!../../../../../node_modules/css-loader/index.js?minimize&-autoprefixer!../../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-2f22dbe6&scoped=true!../../../../../node_modules/sass-loader/index.js!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./egg.vue");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
module.exports = __webpack_require__.p + "images/brokenEgg.5dc9fd967f362a67aa2c4a2c069ec32e.png";
...
module.exports = __webpack_require__.p + "images/egg.aa1340e1f280aff64410438a3870afef.png";
...
module.exports = __webpack_require__.p + "images/eggBackground.6be067c3abbe2d916904aed776704870.png";
...
module.exports = __webpack_require__.p + "images/eggDefaultBanner.f6d7caa987767ce212ab30432a76183b.png";
...
module.exports = "data:image/png;base64,"
...
Component.options.__file = "/Users/genesischou/Documents/integral-mall/src/views/activityDetail/components/egg/egg.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] egg.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-2f22dbe6", Component.options)
  } else {
    hotAPI.reload("data-v-2f22dbe6", Component.options)
  }
})()}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    ref: "eggs",
    staticClass: "eggs"
  }, [_vm._l((6), function(egg, $index) {
    return _c('li', {
      class: {
        active: _vm.active_num == $index + 1
      },
      on: {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-2f22dbe6", module.exports)
  }
}
