...
// module
exports.push([module.i, ".header[data-v-71d91e32]{height:5.33333rem;position:relative}.header img[data-v-71d91e32]{width:100%;height:100%}.header .cover[data-v-71d91e32]{position:absolute;left:0;right:0;bottom:0;height:1.36rem;padding-left:.73333rem;background:rgba(0,0,0,.5)}.fill[data-v-71d91e32]{height:2rem}.main[data-v-71d91e32]{padding:0 .66667rem}.main .introduction[data-v-71d91e32]{margin-top:.66667rem}.main .introduction .title[data-v-71d91e32]{padding:.4rem 0}.footer[data-v-71d91e32]{height:1.33333rem;padding-left:.73333rem}.footer .btn[data-v-71d91e32]{padding:0;width:2.4rem;height:1.33333rem;font-size:.4rem;text-indent:.16rem;letter-spacing:.16rem;border:0;border-radius:0}.footer .btn-disable[data-v-71d91e32]{color:#fff;background-color:#838385;letter-spacing:0;text-indent:0}.modal-content[data-v-71d91e32]{width:8rem;overflow:hidden;text-align:center;padding:.26667rem;background-color:#fff;border-radius:.13333rem}.modal-content .msg[data-v-71d91e32]{padding:.53333rem 0;margin:auto;font-size:.42667rem;text-align:center;width:5.33333rem}.modal-content .pic[data-v-71d91e32]{width:4rem;height:2.8rem}.modal-content .btn[data-v-71d91e32]{width:4rem;height:1.04rem;margin:0 auto;margin-bottom:.4rem;line-height:1.04rem;font-size:.4rem}", ""]);
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!./../../node_modules/.0.25.0@css-loader/index.js!./../../node_modules/.9.9.3@vue-loader/lib/style-rewriter.js?id=data-v-3243718b&scoped=true!./../../node_modules/.4.0.2@sass-loader/index.js!./../../node_modules/.9.9.3@vue-loader/lib/selector.js?type=styles&index=0!./v_sticky.vue", function() {
			var newContent = require("!!./../../node_modules/.0.25.0@css-loader/index.js!./../../node_modules/.9.9.3@vue-loader/lib/style-rewriter.js?id=data-v-3243718b&scoped=true!./../../node_modules/.4.0.2@sass-loader/index.js!./../../node_modules/.9.9.3@vue-loader/lib/selector.js?type=styles&index=0!./v_sticky.vue");
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!./../../node_modules/.0.25.0@css-loader/index.js!./../../node_modules/.9.9.3@vue-loader/lib/style-rewriter.js?id=data-v-71d91e32&scoped=true!./../../node_modules/.4.0.2@sass-loader/index.js!./../../node_modules/.9.9.3@vue-loader/lib/selector.js?type=styles&index=0!./product_detail.vue", function() {
			var newContent = require("!!./../../node_modules/.0.25.0@css-loader/index.js!./../../node_modules/.9.9.3@vue-loader/lib/style-rewriter.js?id=data-v-71d91e32&scoped=true!./../../node_modules/.4.0.2@sass-loader/index.js!./../../node_modules/.9.9.3@vue-loader/lib/selector.js?type=styles&index=0!./product_detail.vue");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_components_v_sticky_vue__ = __webpack_require__(170);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_components_v_sticky_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_components_v_sticky_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_components_v_divider_vue__ = __webpack_require__(65);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_components_v_divider_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_components_v_divider_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_components_v_modal_vue__ = __webpack_require__(67);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_components_v_modal_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_components_v_modal_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_components_v_simditor_vue__ = __webpack_require__(68);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_components_v_simditor_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_components_v_simditor_vue__);
//
//
//
//
...
/* harmony default export */ exports["default"] = {
    ...
    name: 'product_detail',
    components: {
        vSticky: __WEBPACK_IMPORTED_MODULE_0_components_v_sticky_vue___default.a,
        vModal: __WEBPACK_IMPORTED_MODULE_2_components_v_modal_vue___default.a,
        vSimditor: __WEBPACK_IMPORTED_MODULE_3_components_v_simditor_vue___default.a,
        vDivider: __WEBPACK_IMPORTED_MODULE_1_components_v_divider_vue___default.a
    },
    data: function data() {
        return {
            modal: false,
    ...
    methods: {
        ...
        order: function order() {
            ...
            this.$http.post(APP.HOST + '/product_order/' + this.product_id, {
                ...
                var data = response.data;
                _this3.order_state.start = true;
                if (response.data.status === APP.SUCCESS) {
                    _this3.order_state.msg = data.data.name;
                    _this3.order_state.success = true;
                    _this3.order_detail_id = data.data.id;
                    //更新用户数据
                    _this3.$store.dispatch('getUserInfor');
                } else {
                    _this3.order_state.msg = data.info;
                }
...
__vue_options__._scopeId = "data-v-3243718b"
...
module.exports={render:function (){var _vm=this;
  return _vm._h('div', {
    ...
    staticClass: "header flex flex-center-h flex-center-v"
  }, [_vm._h('img', {
    attrs: {
      "src": _vm.product_detail.pic_banner
    }
  }), " ", _vm._h('div', {
    staticClass: "cover text-white  flex flex-center-v"
  }, [_vm._h('p', {
    staticClass: "text-huge text-ellipsis"
  }, [_vm._s(_vm.product_detail.name)])])]), " ", _vm._h('article', {
    staticClass: "main "
  }, [_vm._h('div', {
    staticClass: "introduction"
  }, [_vm._h('v-simditor', [(_vm.product_detail.content) ? [_vm._h('v-divider', {
    attrs: {
      "text": "详细说明"
    }
  }), " ", _vm._h('div', {
    domProps: {
      "innerHTML": _vm._s(_vm.product_detail.content)
    }
  })] : _vm._e(), " ", (_vm.product_detail.content_use) ? [_vm._h('v-divider', {
    attrs: {
      "text": "使用说明"
    }
  }), " ", _vm._h('div', {
  ...
  })] : _vm._e()])]), " ", _vm._m(0)]), " ", _vm._h('v-sticky', [_vm._h('footer', {
    staticClass: "footer flex flex-space-between flex-center-v"
  }, [_vm._h('div', {
    staticClass: "text-large"
  }, ["\n                单价：", _vm._h('span', {
    staticClass: "text-red"
  }, [_vm._s(parseInt(_vm.product_detail.integral) || 0)]), "积分\n            "]), " ", (_vm.integral_enough) ? _vm._h('button', {
  ...
  }, [(_vm.order_state.success) ? _vm._h('header', [_vm._h('img', {
    staticClass: "pic",
    attrs: {
      "src": _vm.product_detail.pic_thumb
    }
  })]) : _vm._e(), " ", _vm._h('div', {
    staticClass: "msg"
  }, [_vm._s(_vm.order_state.msg)]), " ", (_vm.order_state.success) ? _vm._h('router-link', {
    staticClass: "btn btn-red",
    attrs: {
      "tag": "div",
      "to": {
...
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-71d91e32"
...
// module
exports.push([module.i, ".v-sticky[data-v-3243718b]{position:fixed;bottom:0;left:0;right:0;border-top:1px solid #c8c8c8}", ""]);
